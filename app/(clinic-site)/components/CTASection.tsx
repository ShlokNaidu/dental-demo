  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 100%, rgba(13,148,136,0.18) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <p className="label-caps text-teal mb-6">Start Your Journey Today</p>
          <h2 className="text-display-md text-ivory mb-6">
            Ready for a Healthier,<br />
            <span style={{ color: "var(--teal)" }}>Brighter Smile?</span>
          </h2>
          <p className="text-lg mb-12 max-w-xl mx-auto" style={{ color: "var(--stone-400)" }}>
